  ...
  return (
    <PageShell>
      <section className="inner-hero factory-hero">
        ...
        <div className="factory-hero-logo"><Image src="/assets/mirko-brand-2026.png" alt="Новый фирменный знак MIRKO IZOBASALT" fill sizes="(max-width: 820px) 100vw, 50vw" priority unoptimized /></div>
      </section>
