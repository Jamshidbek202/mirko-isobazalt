...
const copy = {
  ru: {
    ...
    "hero.scroll": "Листайте", "hero.mobileNote": "На мобильном — быстрая статичная версия. Интерактивная 3D-модель доступна на большом экране.",
    ...
    "form.name": "Ваше имя", "form.namePlaceholder": "Как к вам обращаться?", "form.phone": "Телефон", "form.region": "Регион", "form.regionPlaceholder": "Например, Фергана", "form.project": "Тип объекта", "form.message": "О проекте", "form.messagePlaceholder": "Площадь, сроки или другие детали", "form.submit": "Отправить заявку", "form.consent": "Нажимая кнопку, вы соглашаетесь с политикой конфиденциальности.",
    ...
    "review.author": "Имя или компания", "review.object": "Тип объекта", "review.rating": "Оценка", "review.text": "Ваш отзыв", "review.submit": "Отправить на модерацию", "review.note": "Отзыв отправится через вашу почтовую программу и появится после проверки.",
  },
  uz: {
    ...
    "hero.scroll": "Pastga", "hero.mobileNote": "Mobil qurilmada tezkor statik ko‘rinish. Interaktiv 3D model katta ekranda mavjud.",
    ...
    "review.author": "Ism yoki kompaniya", "review.object": "Obyekt turi", "review.rating": "Baho", "review.text": "Fikringiz", "review.submit": "Tekshiruvga yuborish", "review.note": "Fikr pochta dasturingiz orqali yuboriladi va tekshiruvdan keyin chiqadi.",
  },
  en: {
    ...
    "hero.scroll": "Scroll", "hero.mobileNote": "A fast static presentation is used on mobile. Interactive 3D is available on larger screens.",
    ...
    "review.author": "Name or company", "review.object": "Project type", "review.rating": "Rating", "review.text": "Your review", "review.submit": "Send for review", "review.note": "Your review opens in your email app and appears after verification.",
  },
} as const;
